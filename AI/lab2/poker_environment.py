...
def poker_strategy_example(opponent_hand,
    ...
    print('opponent_hand_strength:',opponent_hand_strength)
    if bidding_nr >= max_phase:
        ...
        if opponent_hand_strength == 'weak':  #replaced is with '=='
            if bidding_nr < 3:
        ...
        elif opponent_hand_strength == 'median':  #replaced is with '=='
            if bidding_nr < 2:
                if agent_action_value == 25:
                    opponent_action = 'BET'
                    opponent_action_value = 10
        ...
        elif opponent_hand_strength == 'strong':  #replaced is with '=='
            if bidding_nr < 2:
                if agent_action_value == 25:
                    opponent_action = 'BET'
                    opponent_action_value = 25
...
def generate_2hands(nn_card=5):
     ...
     print('cards:',cards_[:nn_card])
     print('cards:', cards_[nn_card:])
     return cards_[:nn_card], cards_[nn_card:]

#fixed_hands = [generate_2hands() for xx in range(20)]

fixed_hands = [(['Kc', 'Qc', 'Qh', 'Qs', '4d'], ['2s', '8s', '4c', '3s', '4h']),
               (['As', 'Ac', '3s', 'Ad', 'Ah'], ['Kd', '7d', '2s', '5h', '2c']),
               (['Ks', 'Kc', 'Kd', 'Kh', 'Ah'], ['8c', 'As', '6c', '4h', 'Kd']),
               (['As', 'Ac', '3s', 'Ad', 'Ah'], ['5s', '9c', 'Qh', '8h', '3s']),
               (['As', 'Ac', '3s', 'Ad', 'Ah'], ['Ks', '9c', '8c', 'Ts', '6d']),
               (['Ks', 'Kc', 'Kd', 'Kh', 'Ah'], ['Kc', 'Jc', '2s', '5d', '3s']),
    ...
    #print('fixed_hands:', fixed_hands)
    #return fixed_hands[0][0],fixed_hands[0][1]
